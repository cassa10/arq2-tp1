...
func (m *MockSellerRepository) Create(ctx context.Context, seller model.Seller) (*model.Seller, error) {
	m.ctrl.T.Helper()
...
func (m *MockSellerRepository) Update(ctx context.Context, seller model.Seller) (*model.Seller, error) {
	m.ctrl.T.Helper()
